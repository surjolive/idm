...
::============================================================================
::
::   IDM Activation Script (By SURJOLIVE)
::
::   Homepages: https://github.com/surjolive
::
::       Telegram: @surjolive
::
::============================================================================
...
set "blank="
set "mas=https://github.com/surjolive"
...
echo:
echo:
echo Help - %mas%/IDM-Freezer-Activation-Tool#troubleshoot
echo:
echo:
ping 127.0.0.1 -n 10
)
...
cls
color 07
title  IDM Activation Script - SURJOLIVE
...
echo:
echo:
call :_color2 %_White% "             " %_Green% "Create By SURJOLIVE"
echo:            ___________________________________________________
echo:
echo:               Telegram: @surjolive
echo:               Github: https://github.com/surjolive
echo:            ___________________________________________________
echo:
echo:               [1] Activate
echo:               [2] Freeze Trial
